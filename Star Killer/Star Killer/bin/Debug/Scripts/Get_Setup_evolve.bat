...
c:\python27\scripts\pip.exe install yara
c:\python27\scripts\pip.exe install bottle 
c:\python27\scripts\pip.exe install distorm3 
c:\python27\scripts\pip.exe install maxminddb
c:\python27\scripts\pip.exe install PyCrypto
c:\python27\scripts\pip.exe install pycrypto 
c:\python27\scripts\pip.exe install distorm3
c:\python27\scripts\pip.exe install Pil
c:\python27\scripts\pip.exe install libforensic1394
c:\python27\scripts\pip.exe install IPython 
c:\python27\scripts\pip.exe install pytz
c:\python27\scripts\pip.exe install ujson 
c:\python27\scripts\pip.exe install Crypto
c:\python27\scripts\pip.exe install Crypto.Hash
